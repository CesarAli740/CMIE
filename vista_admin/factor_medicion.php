				...
				while ($fila = mysqli_fetch_array($dato)) {
					...
					<tbody>
						<tr>
							...
							<td>
								<a class="btn btn-warning" href="./editar_indicador.php?id=<?php echo $fila['id_factores'] ?> ">
									<i class="fas fa-edit"></i> </a>
								<a class="btn btn-danger" href="./eliminar_indicador.php?id=<?php echo $fila['id_factores'] ?>">
