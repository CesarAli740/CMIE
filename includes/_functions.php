...
function eliminar_unidad()
{
  ...
  $conc = 'c' . $id;
  $consulta2 = "ALTER TABLE dimensiones DROP COLUMN $conc";
  mysqli_query($conexion, $consulta2);

  $consulta3 = "ALTER TABLE notas_factores DROP COLUMN $conc";
  mysqli_query($conexion, $consulta3);

  $consulta3 = "ALTER TABLE subfactor DROP COLUMN $conc";
  mysqli_query($conexion, $consulta3);
