...
if (isset($_POST['registrar'])) {
  if (
    ...
    $consulta = "INSERT INTO user (nombre, apPAt, apMAt, correo, grado, telefono, password, rol, gunidad, division, unidad, id_unidad)
    VALUES ('$nombre', '$apPAt', '$apMAt', '$correo', '$grado','$telefono','$password', '$rol', '$gunidad', '$division', '$unidad', '$id_unidad')";
    ...
    /* if ($rol == 2) {
      ...
      $tabla = "dimension" . $unidad;
      //sentencia SQL para crear la tabla
      $sql = "CREATE TABLE IF NOT EXISTS $tabla(id tinyint PRIMARY KEY)";
